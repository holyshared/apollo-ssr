...
export type GategoryResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Gategory"] = ResolversParentTypes["Gategory"]
> = {
...
export type GategoryPagingResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GategoryPaging"] = ResolversParentTypes["GategoryPaging"]
> = {
  edges?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Gategory"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<
...
> = {
  ...
  name?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  categories?: Resolver<
    Maybe<ResolversTypes["GategoryPaging"]>,
    ParentType,
    ContextType,
    RequireFields<UserCategoriesArgs, never>
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
